import { Text, View, Image, Button, TouchableOpacity, Alert, Pressable } from 'react-native'
...
const App = () => {
  ...
  return (
    ...
    <SafeAreaView style={style.container}>
      ...
      >
        <Text>Presss meeeee Buddyyyyy</Text>
      </TouchableOpacity>
      ...
      >
        <Text style={styles.btnTxt}>Pressableee</Text>
      </Pressable>
